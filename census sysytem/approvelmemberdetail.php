...
{ ?>
<tr>
<td><a href="approvelmemberdetail.php?id=<?php echo $roww['id'];?>" >Detail</a></td>
...
<caption style="font-size:25px; color:#FFF">Approved Member</caption>
<th>ID</th><th>Name</th><th>Gender</th><th>Relation</th>
<?php 
include("connection.php");
$idd=$_REQUEST['id'];
$quer="select * from member  where id like '$idd%'";
...
<td><?php echo $rowww['relation']; ?></td>
<td><?php echo $rowww['gender']; ?></td>
</tr>
<?php }?>
</table>
</div>
